...
_DEFAULTS: dict[str, Any] = {
    ...
    "scalp.mtf_candidate_episode_cooldown_min": lambda: 30,
    "scalp.mtf_observation_blocked_sessions": lambda: ["LUNCH_BLOCK"],
    ...
    "scalp.shadow_ticker_episode_cooldown_min": lambda: 15,
    ...
    "scalp.entry_quality_mtf_aligned_bonus": lambda: 8.0,
    "scalp.entry_quality_mtf_mixed_penalty": lambda: 8.0,
    "scalp.entry_quality_require_mtf_context": lambda: True,
