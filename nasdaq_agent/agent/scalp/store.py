    ...
    with _init_lock:
        ...
        statements = [
            ...
            CREATE TABLE IF NOT EXISTS scalp_shadow_trades (
                ...
                fill_slippage_r     DOUBLE PRECISION DEFAULT 0,
                stop_overshoot_r    DOUBLE PRECISION DEFAULT 0,
            ...
            CREATE TABLE IF NOT EXISTS scalp_cycle_metrics (
                ...
                execution_data_gap_count INTEGER NOT NULL DEFAULT 0,
        ...
        migrations = [
            ...
            "ALTER TABLE scalp_shadow_trades ADD COLUMN IF NOT EXISTS evidence_version INTEGER NOT NULL DEFAULT 1",
            ...
            "ALTER TABLE scalp_shadow_trades ADD COLUMN IF NOT EXISTS planned_exit_price DOUBLE PRECISION",
            "ALTER TABLE scalp_shadow_trades ADD COLUMN IF NOT EXISTS fill_slippage_r DOUBLE PRECISION DEFAULT 0",
            "ALTER TABLE scalp_shadow_trades ADD COLUMN IF NOT EXISTS stop_overshoot_r DOUBLE PRECISION DEFAULT 0",
            ...
            "ALTER TABLE scalp_candidate_trials ADD COLUMN IF NOT EXISTS planned_exit_price DOUBLE PRECISION",
            "ALTER TABLE scalp_candidate_trials ADD COLUMN IF NOT EXISTS fill_slippage_r DOUBLE PRECISION DEFAULT 0",
            "ALTER TABLE scalp_candidate_trials ADD COLUMN IF NOT EXISTS stop_overshoot_r DOUBLE PRECISION DEFAULT 0",
            "ALTER TABLE scalp_cycle_metrics ADD COLUMN IF NOT EXISTS execution_universe_total INTEGER NOT NULL DEFAULT 0",
            "ALTER TABLE scalp_cycle_metrics ADD COLUMN IF NOT EXISTS execution_data_gap_count INTEGER NOT NULL DEFAULT 0",
...
def record_cycle_metrics(metrics: dict[str, Any], *, observed_at: float | None = None) -> str:
    ...
    values = (
        ...
        int(metrics.get("execution_data_gap_count") or 0),
        ...
        conn.execute(
            ...
            INSERT INTO scalp_cycle_metrics
              (bucket_ts, session, universe_total, valid_plan_count,
               ...
               execution_universe_total, execution_data_gap_count, cycle_ms,
            ...
            ON CONFLICT (bucket_ts) DO UPDATE SET
              ...
              execution_data_gap_count=excluded.execution_data_gap_count,
