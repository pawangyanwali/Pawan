...
def create_scalp_signal_plan(
    *,
    ...
    return ScalpSignalPlan(
        ...
        indicator_close=number(indicators.indicator_close),
        rsi_avg_gain_14=number(indicators.rsi_avg_gain_14),
        rsi_avg_loss_14=number(indicators.rsi_avg_loss_14),
        rsi_avg_gain_7=number(indicators.rsi_avg_gain_7),
        rsi_avg_loss_7=number(indicators.rsi_avg_loss_7),
        rsi_avg_gain_2=number(indicators.rsi_avg_gain_2),
        rsi_avg_loss_2=number(indicators.rsi_avg_loss_2),
        macd_fast_ema=number(indicators.macd_fast_ema),
        macd_slow_ema=number(indicators.macd_slow_ema),
        macd_signal_ema=number(indicators.macd_signal_ema),
