...
_ALGO_FAMILY_MAP: dict[str, str] = {
    ...
    # ── Phase 5: Quant Strategy Reference ─────────────────────────────────────
    "OFI_IMPULSE_BULL":   "OFI",          "OFI_IMPULSE_BEAR":   "OFI",
    "QUEUE_MICRO_BULL":   "OFI",          "QUEUE_MICRO_BEAR":   "OFI",
    "AGG_VOL_MOM_BULL":   "OFI",          "AGG_VOL_MOM_BEAR":   "OFI",
    ...
    "MACD_ACC_BULL":      "MACD_ACC",    "MACD_ACC_BEAR":      "MACD_ACC",
    "SUPERTREND_BULL":    "SUPERTREND",  "SUPERTREND_BEAR":    "SUPERTREND",
    "VOL_SHOCK_BULL":     "VOL_SHOCK",   "VOL_SHOCK_BEAR":     "VOL_SHOCK",
    "BB_MEAN_REV_BULL":   "BB_REV",      "BB_MEAN_REV_BEAR":   "BB_REV",
    "RSI2_SNAP_BULL":     "BB_REV",      "RSI2_SNAP_BEAR":     "BB_REV",
    "KC_FADE_BULL":       "KELTNER_FADE","KC_FADE_BEAR":       "KELTNER_FADE",
    "FAILED_BRK_BULL":    "KELTNER_FADE","FAILED_BRK_BEAR":    "KELTNER_FADE",
    "SQUEEZE_EXP_BULL":   "SQUEEZE",     "SQUEEZE_EXP_BEAR":   "SQUEEZE",
    "PAIR_STAT_ARB_LONG": "PAIR_ARB",    "PAIR_STAT_ARB_SHORT":"PAIR_ARB",
    "REGIME_TREND_BULL":  "REGIME_SW",   "REGIME_TREND_BEAR":  "REGIME_SW",
    "REGIME_FADE_BULL":   "REGIME_SW",   "REGIME_FADE_BEAR":   "REGIME_SW",
    "META_ENS_BULL":      "META_ENS",    "META_ENS_BEAR":      "META_ENS",
}

_ALL_FAMILIES = {
    "ORB", "GAP_TREND", "GAP_FADE", "AH_GAP_FADE", "BREAKOUT", "FLAG",
    "VWAP_SCALP", "LEVEL_SCALP", "RS_REGIME",
    # Phase 5 quant families
    "OFI", "VWAP_OFI", "EMA_PULL", "VWAP_TREND", "DONCHIAN", "ORB_ZV",
    "MACD_ACC", "SUPERTREND", "VOL_SHOCK", "BB_REV", "KELTNER_FADE",
    "SQUEEZE", "PAIR_ARB", "REGIME_SW", "META_ENS",
}
